...
bool Quadrilateral::isSquare()
{
  ...
  cout << "Dot product: " << dotProduct(direction1, direction2) << endl;

  bool adjacentLinesPerpendicular = abs(dotProduct(direction1, direction2)) < 1e-6;

  cout << "Lines perpendicular: " << adjacentLinesPerpendicular << endl;
